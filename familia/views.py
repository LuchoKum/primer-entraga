...
def agregar(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            Persona(nombre=nombre, apellido=apellido, email=email, fecha_nacimiento=fecha_nacimiento, altura=altura, tipo=tipo, marca=marca, modelo=modelo, especie=especie, raza=raza,edad=edad).save()
